...
import { QueueTestJob } from './common/jobs/queue.test.job';

@Controller()
export class AppController {
    constructor(private readonly appService: AppService, private readonly queueService: QueueService, private readonly queueTestJob: QueueTestJob) {}
    ...
    @Get('set')
    async set() {
        return this.queueTestJob.delayedDispatch(1);
    }
}
